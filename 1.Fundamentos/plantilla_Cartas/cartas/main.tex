...
\name{Anderson}{Cárdenas}
\title{Resumé title}                               % opcional, remover o comentar si no quiere que aparezca su título personal
\address{Quito}{265758}{Ecuador}% opcional, remover o comentar si no quiere que aparezca sus datos de ubicación; el código postal y país son argumentos que puede omitirse o pasarse vacíos
\phone[mobile]{983200592}		                   % opcional, remover o comentar si no quiere incluir su número de móvil
\phone[fixed]{3010913}       		           % opcional, remover o comentar si no quiere incluir su número de teléfono fijo
\phone[fax]{+3~(456)~789~012}                      % opcional, remover o comentar si no quiere incluir su número de fax
\email{anderson@gmail.com}                               % opcional, remover o comentar si no quiere incluir su dirección de email
\homepage{www.andersoncardenas.com}                         % opcional, remover o comentar si no quiere incluir su dirección web
\extrainfo{Aprendiendo a manejar plantillas de Latex}                  % opcional, remover o comentar si no quiere información adicional
...
\recipient{Fernando Real}{Quito, Ecuador}
\date{28/10/2021}
\opening{Saludo}
